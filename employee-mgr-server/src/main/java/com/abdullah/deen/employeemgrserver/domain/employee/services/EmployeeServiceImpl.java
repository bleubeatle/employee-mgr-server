...
import com.abdullah.deen.employeemgrserver.domain.employee.repos.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    @Override
    public Employee creates(Employee employee) throws ResourceCreationException {
        Optional<Employee> optional = employeeRepository.findByEmail(employee.getEmail());
        if (optional.isPresent())throw new ResourceCreationException("Employee with email exists: " + employee.getEmail());
